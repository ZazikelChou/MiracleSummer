...
},{"./Observer.js":"node_modules/gsap/Observer.js"}],"node_modules/gsap/ScrollToPlugin.js":[function(require,module,exports) {
"use strict";
...
},{"./utils/strings.js":"node_modules/gsap/utils/strings.js"}],"node_modules/gsap/DrawSVGPlugin.js":[function(require,module,exports) {
"use strict";
...
var DrawSVGPlugin = exports.default = exports.DrawSVGPlugin = {
  version: "3.12.5",
  name: "drawSVG",
  register: function register(core) {
    gsap = core;
...
*/
},{}],"node_modules/gsap/MorphSVGPlugin.js":[function(require,module,exports) {
"use strict";
...
var gsap,
  ...
  _pathFilter = function _pathFilter(a, shapeIndex, map, precompile, fillSafe) {
    var start = (0, _paths.stringToRawPath)(a[0]),
      end = (0, _paths.stringToRawPath)(a[1]);
...
var MorphSVGPlugin = exports.default = exports.MorphSVGPlugin = {
  version: "3.12.5",
  name: "morphSVG",
  rawVars: 1,
...
},{"./utils/paths.js":"node_modules/gsap/utils/paths.js"}],"node_modules/gsap/SplitText.js":[function(require,module,exports) {
"use strict";
...
},{"./utils/strings.js":"node_modules/gsap/utils/strings.js"}],"img/fv_bg@2x.png":[function(require,module,exports) {
module.exports = "/fv_bg@2x.00c2240d.png";
...
_gsap.gsap.to("#rockets", {
  ...
  onComplete: function onComplete() {
    ...
    _gsap.gsap.to("#rockets", {
      ...
      onComplete: function onComplete() {
        // 重置位置并延迟3秒后开始渐显
        _gsap.gsap.set("#rockets", {
          x: 0,
          y: 0,
          opacity: 0
        }); // 使用 set 来立即重置位置而不产生动画效果
        _gsap.gsap.to("#rockets", {
          opacity: 1,
          duration: 0.5,
...
document.addEventListener("DOMContentLoaded", function () {
  ...
  _gsap.gsap.to(".header", {
    scrollTrigger: {
      ...
      // 触发动画的元素
      start: "top top",
      // 动画开始的位置（当.header顶部到达视口顶部）
      end: function end() {
        return "+=" + (window.innerHeight + document.querySelector(".main").offsetHeight * 0.5);
      },
      // 动画结束的位置，这里使用一个函数动态计算，基于.window的高度加上.main元素高度的一半
      scrub: 1,
      // 动画的平滑过渡时间（以秒计），这里设置为1秒内平滑过渡
  ...
  _gsap.gsap.fromTo("#overview", {
    ...
    scrollTrigger: {
      ...
      // 触发动画的元素
      start: "top 300%",
      // 动画开始的位置（当.main顶部到达视口顶部的200%位置）
      end: "top 50%",
      // 动画结束的位置（当.main顶部到达视口顶部的50%位置）
...
document.addEventListener('DOMContentLoaded', function () {
  var revealTypes = document.querySelectorAll('.reveal-type');
  revealTypes.forEach(function (char) {
    // 仅使用 chars 类型分割，避免引入额外的 word 分割
    var text = new _SplitText.SplitText(char, {
      type: 'chars'
    });
    var normalChars = Array.from(text.chars).filter(function (c) {
      return !c.closest('.static-color');
    });
    var specialChars = Array.from(text.chars).filter(function (c) {
      return c.closest('.static-color');
    });

    // 确保所有生成的元素都以 inline-block 显示
    text.chars.forEach(function (c) {
      return c.style.display = 'inline-block';
    });

    // 应用动画到 normalChars
    _gsap.gsap.fromTo(normalChars, {
      color: 'transparent',
    ...
    // 应用动画到 specialChars
    _gsap.gsap.fromTo(specialChars, {
      color: 'transparent',
      webkitTextStroke: '1px #3B3532'
    }, {
      color: '#366AB3',
...
function adjustStoryHeight() {
  var storyBg = document.getElementById('story-bg');
...
document.addEventListener("DOMContentLoaded", function () {
  ...
  var staffInfos = document.querySelectorAll(".staff-info");
  staffCards.forEach(function (card) {
    var svgPaths = card.querySelectorAll('.staff-item-R svg path');
    card.addEventListener("mouseenter", function () {
      _gsap.gsap.to(svgPaths, {
        stroke: "#F4C53A",
        duration: 0.5
      });
    });
    ...
    card.addEventListener("click", function (event) {
      var infoId = this.querySelector(".staff-item").getAttribute("data-info");
      var infoElement = document.getElementById(infoId);

      // 关闭所有已打开的卡片，并复原SVG
      staffInfos.forEach(function (info) {
        var openCard = info.closest(".staff-card");
        var openSvgPaths = openCard.querySelectorAll('.staff-item-R svg path');
        if (info !== infoElement && info.style.display === "grid") {
          ...
          _gsap.gsap.to(openSvgPaths, {
            morphSVG: "#original-svg-path",
            duration: 0.5
          });
        }
      });
      ...
      if (infoElement.style.display === "none" || !infoElement.style.display) {
        ...
        _gsap.gsap.fromTo(infoElement, {
          height: 0,
          opacity: 0
        }, {
          height: infoElement.scrollHeight,
          opacity: 1,
          duration: 0.5
        });
...
// bento动画
var brandContact = document.querySelector('.brand-contact');
var brandContactBg = document.querySelector('.brand-contact-bg');
var contactContainerM = document.querySelector('.contact-container-m');
var otherElements = document.querySelectorAll('.contact-container-t, .contact-container-b');
brandContact.addEventListener('mouseenter', function () {
  _gsap.gsap.to(brandContactBg, {
    opacity: 1,
    duration: 0.3
  });
  _gsap.gsap.to(contactContainerM, {
    color: '#EFEFEF',
    scale: 0.8,
    duration: 0.3
  });
  _gsap.gsap.to(otherElements, {
    opacity: 0,
    duration: 0.3
  });
});
brandContact.addEventListener('mouseleave', function () {
  _gsap.gsap.to(brandContactBg, {
    opacity: 0,
    duration: 0.3
  });
...
var outlineProjectsBg = document.querySelector('.outline-projects-bg');
var outlineProjectsStickers = document.querySelector('.outline-projects-stickers img');
var outlineProjectsArrow = document.querySelector('.outline-projects-arrow svg');
var projectList = document.querySelectorAll('.project-list');
projects.addEventListener('mouseenter', function () {
  _gsap.gsap.to(outlineProjectsBg, {
    opacity: 1,
    duration: 0.3
  });
  _gsap.gsap.to(outlineProjectsStickers, {
    opacity: 0.7,
    scale: 0.8,
    duration: 0.3
  });
  _gsap.gsap.to(outlineProjectsArrow, {
    stroke: '#EFEFEF',
    duration: 0.3
  });
  _gsap.gsap.to(projectList, {
    opacity: 0,
    duration: 0.3
  });
});
...
var budgetProjectsBg = document.querySelector('.budget-projects-bg');
var budgetProjectsStickers = document.querySelector('.budget-projects-stickers img');
var budgetProjectsArrow = document.querySelector('.budget-projects-arrow svg');
var budgettList = document.querySelectorAll('.budget-list');
budget.addEventListener('mouseenter', function () {
  _gsap.gsap.to(budgetProjectsBg, {
    opacity: 1,
    duration: 0.3
  });
  _gsap.gsap.to(budgetProjectsStickers, {
    opacity: 0.7,
    scale: 0.8,
    duration: 0.3
  });
  _gsap.gsap.to(budgetProjectsArrow, {
    stroke: '#EFEFEF',
    duration: 0.3
  });
  _gsap.gsap.to(budgettList, {
    opacity: 0,
    duration: 0.3
  });
});
budget.addEventListener('mouseleave', function () {
  _gsap.gsap.to(budgetProjectsBg, {
    opacity: 0,
    duration: 0.3
  });
...
var newsProjectsBg = document.querySelector('.news-projects-bg');
var newstProjectsStickers = document.querySelector('.news-projects-stickers img');
var newstProjectsArrow = document.querySelector('.news-projects-arrow svg');
var newsList = document.querySelectorAll('.news-list');
news.addEventListener('mouseenter', function () {
  _gsap.gsap.to(newsProjectsBg, {
    opacity: 1,
    duration: 0.3
  });
  _gsap.gsap.to(newstProjectsStickers, {
    opacity: 0.7,
    scale: 0.8,
    duration: 0.3
  });
  _gsap.gsap.to(newstProjectsArrow, {
    stroke: '#EFEFEF',
    duration: 0.3
  });
  _gsap.gsap.to(newsList, {
    opacity: 0,
    duration: 0.3
  });
});
...
function horizontalLoop(items, config) {
  items = _gsap.gsap.utils.toArray(items);
  config = config || {};
  var tl = _gsap.gsap.timeline({
    ...
    snap = config.snap === false ? function (v) {
      return v;
    } : _gsap.gsap.utils.snap(config.snap || 1),
    totalWidth = 0,
    curX,
    distanceToStart,
    distanceToLoop,
  ...
  _gsap.gsap.set(items, {
    xPercent: function xPercent(i, el) {
      var w = widths[i] = parseFloat(_gsap.gsap.getProperty(el, "width", "px"));
      xPercents[i] = snap(parseFloat(_gsap.gsap.getProperty(el, "x", "px")) / w * 100 + _gsap.gsap.getProperty(el, "xPercent"));
      return xPercents[i];
    }
  });
  _gsap.gsap.set(items, {
  ...
  totalWidth = items[length - 1].offsetLeft + xPercents[length - 1] / 100 * widths[length - 1] - startX + items[length - 1].offsetWidth * _gsap.gsap.getProperty(items[length - 1], "scaleX") + (parseFloat(config.paddingRight) || 0);
  ...
  for (i = 0; i < length; i++) {
    ...
    distanceToLoop = distanceToStart + widths[i] * _gsap.gsap.getProperty(item, "scaleX");
    tl.to(item, {
  ...
  function toIndex(index, vars) {
    ...
    var newIndex = _gsap.gsap.utils.wrap(0, length, index),
      time = times[newIndex];
    if (time > tl.time() !== index > curIndex) {
      vars.modifiers = {
        time: _gsap.gsap.utils.wrap(0, tl.duration())
      };
...
document.querySelectorAll(".product-footer-stripe").forEach(function (stripe) {
  var stripe1 = stripe.querySelector(".product-footer-stripe1");
  var stripe2 = stripe.querySelector(".product-footer-stripe2");
  var elems2 = _gsap.gsap.utils.toArray(stripe.querySelectorAll(".product-footer-elem"));
  var loop2 = horizontalLoop(elems2, {
    paused: false,
    repeat: -1,
    speed: 1,
    paddingRight: 0
...
_gsap.gsap.from(".budget-list h3", 0.1, {
  opacity: 0,
  ease: "power4.out",
  delay: 2
});
_gsap.gsap.from("#earth2, #earth3", 2, {
  scale: 0,
  ease: "power4.out",
  delay: 2
});
_gsap.gsap.to("h2, h3", 1, {
  top: 0,
  ease: "power4.out",
  delay: 2,
  stagger: {
...
(function ($) {
  ...
  $(document).ready(function () {
    ...
    $(window).on('scroll', function () {
      ...
      if (windowSize + scrollPosition >= bodyHeight - 10) {
...
document.addEventListener('DOMContentLoaded', function () {
  ...
  var arrows = document.querySelectorAll('.detail-card-arrow');
  triggers.forEach(function (trigger) {
    trigger.addEventListener('click', function () {
      var targetClass = ".detail-card-".concat(this.getAttribute('data-target'));
      var targetCard = document.querySelector(targetClass);

      // 先设置 display 为 flex，然后再进行 opacity 动画
      _gsap.gsap.set(targetCard, {
        display: 'flex'
      });
      _gsap.gsap.fromTo(targetCard, {
        opacity: 0
      }, {
        opacity: 1,
        duration: 0.5,
...
},{"gsap":"node_modules/gsap/index.js","gsap/ScrollTrigger":"node_modules/gsap/ScrollTrigger.js","gsap/ScrollToPlugin":"node_modules/gsap/ScrollToPlugin.js","gsap/TextPlugin":"node_modules/gsap/TextPlugin.js","gsap/DrawSVGPlugin":"node_modules/gsap/DrawSVGPlugin.js","gsap/MorphSVGPlugin":"node_modules/gsap/MorphSVGPlugin.js","gsap/SplitText":"node_modules/gsap/SplitText.js","../img/fv_bg@2x.png":"img/fv_bg@2x.png"}],"../../.volta/tools/image/packages/parcel-bundler/lib/node_modules/parcel-bundler/src/builtins/hmr-runtime.js":[function(require,module,exports) {
...
},{}]},{},["../../.volta/tools/image/packages/parcel-bundler/lib/node_modules/parcel-bundler/src/builtins/hmr-runtime.js","javaScript/main.js"], null)
//# sourceMappingURL=/main.eb213502.js.map