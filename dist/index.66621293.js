...
})({"j5uBC":[function(require,module,exports) {
...
module.bundle.HMR_BUNDLE_ID = "3547e30466621293";
"use strict";
...
},{}],"7FRXk":[function(require,module,exports) {
var parcelHelpers = require("@parcel/transformer-js/src/esmodule-helpers.js");
var _gsap = require("gsap");
var _scrollTrigger = require("gsap/ScrollTrigger");
var _scrollToPlugin = require("gsap/ScrollToPlugin");
var _textPlugin = require("gsap/TextPlugin");
/* The following plugins are Club GSAP perks */ var _drawSVGPlugin = require("gsap/DrawSVGPlugin");
var _morphSVGPlugin = require("gsap/MorphSVGPlugin");
var _splitText = require("gsap/SplitText");
var _fvBg2XPng = require("../img/fv_bg@2x.png");
var _fvBg2XPngDefault = parcelHelpers.interopDefault(_fvBg2XPng);
"use strict";
(0, _gsap.gsap).registerPlugin((0, _scrollTrigger.ScrollTrigger), (0, _scrollToPlugin.ScrollToPlugin), (0, _textPlugin.TextPlugin), (0, _drawSVGPlugin.DrawSVGPlugin), (0, _morphSVGPlugin.MorphSVGPlugin), (0, _splitText.SplitText));
document.addEventListener("DOMContentLoaded", ()=>{
    const svgImage = document.querySelector("#mainShape2 image");
    if (svgImage) svgImage.setAttribute("href", (0, _fvBg2XPngDefault.default));
});
// 路径数据
const paths = [
...
// 地球旋转动画
(0, _gsap.gsap).to("#earth", {
    rotation: 360,
    duration: 10,
    ease: "none",
    repeat: -1 // 无限重复
});
(0, _gsap.gsap).to("#earth2", {
    rotation: 360,
    duration: 10,
    ease: "none",
    repeat: -1 // 无限重复
...
document.addEventListener("DOMContentLoaded", function() {
    ...
    revealTypes.forEach((char)=>{
        ...
        const text = new (0, _splitText.SplitText)(char, {
            type: "chars"
        });
        ...
        // 应用动画到 normalChars
        (0, _gsap.gsap).fromTo(normalChars, {
            color: "transparent",
        ...
        // 应用动画到 specialChars
        (0, _gsap.gsap).fromTo(specialChars, {
            color: "transparent",
            webkitTextStroke: "1px #3B3532"
        }, {
            color: "#366AB3",
...
function adjustStoryHeight() {
    ...
    if (storyBg && story) story.style.height = storyBg.offsetHeight + "px";
}
// 在页面加载时调整高度
    ...
    staffCards.forEach((card)=>{
        ...
        card.addEventListener("click", function(event) {
            ...
            if (infoElement.style.display === "none" || !infoElement.style.display) {
                ...
                (0, _gsap.gsap).fromTo(infoElement, {
                    height: 0,
                    opacity: 0
                }, {
...
brandContact.addEventListener("mouseenter", ()=>{
    (0, _gsap.gsap).to(brandContactBg, {
        opacity: 1,
        duration: 0.3
    });
    (0, _gsap.gsap).to(contactContainerM, {
        color: "#EFEFEF",
        duration: 0.3
    });
    (0, _gsap.gsap).to(otherElements, {
        opacity: 0,
        duration: 0.3
    });
});
...
projects.addEventListener("mouseenter", ()=>{
    (0, _gsap.gsap).to(outlineProjectsBg, {
        opacity: 1,
        duration: 0.3
    });
    (0, _gsap.gsap).to(outlineProjectsStickers, {
        opacity: 0.7,
        duration: 0.3
    });
    (0, _gsap.gsap).to(outlineProjectsArrow, {
        stroke: "#EFEFEF",
        duration: 0.3
    });
    (0, _gsap.gsap).to(projectList, {
        opacity: 0,
        duration: 0.3
    });
});
...
(0, _gsap.gsap).from(".budget-list h3", 0.1, {
    opacity: 0,
    ease: "power4.out",
    delay: 2
});
(0, _gsap.gsap).from("#earth2, #earth3", 2, {
    scale: 0,
    ease: "power4.out",
    delay: 2
});
(0, _gsap.gsap).to("h2, h3", 1, {
    top: 0,
    ease: "power4.out",
    delay: 2,
    stagger: {
...
(0, _gsap.gsap).from(".marquee", 1, {
    bottom: "-10em",
    ease: "power4.out",
    delay: 3
});

},{"gsap":"fPSuC","gsap/ScrollTrigger":"7wnFk","gsap/ScrollToPlugin":"9xJDW","gsap/TextPlugin":"9TeAU","gsap/DrawSVGPlugin":"htWnw","gsap/MorphSVGPlugin":"3eezk","gsap/SplitText":"63tvY","../img/fv_bg@2x.png":"cb3TM","@parcel/transformer-js/src/esmodule-helpers.js":"apnIf"}],"fPSuC":[function(require,module,exports) {
var parcelHelpers = require("@parcel/transformer-js/src/esmodule-helpers.js");
...
},{"./gsap-core.js":"05eeC","./CSSPlugin.js":"l02JQ","@parcel/transformer-js/src/esmodule-helpers.js":"apnIf"}],"05eeC":[function(require,module,exports) {
var parcelHelpers = require("@parcel/transformer-js/src/esmodule-helpers.js");
parcelHelpers.defineInteropFlag(exports);
...
},{"@parcel/transformer-js/src/esmodule-helpers.js":"apnIf"}],"apnIf":[function(require,module,exports) {
...
},{"./gsap-core.js":"05eeC","@parcel/transformer-js/src/esmodule-helpers.js":"apnIf"}],"7wnFk":[function(require,module,exports) {
/*!
...
},{"./Observer.js":"aAWxM","@parcel/transformer-js/src/esmodule-helpers.js":"apnIf"}],"aAWxM":[function(require,module,exports) {
var parcelHelpers = require("@parcel/transformer-js/src/esmodule-helpers.js");
parcelHelpers.defineInteropFlag(exports);
...
},{"@parcel/transformer-js/src/esmodule-helpers.js":"apnIf"}],"9xJDW":[function(require,module,exports) {
/*!
...
},{"@parcel/transformer-js/src/esmodule-helpers.js":"apnIf"}],"9TeAU":[function(require,module,exports) {
/*!
 * TextPlugin 3.12.5
 * https://gsap.com
 *
...
},{"./utils/strings.js":"2xmbo","@parcel/transformer-js/src/esmodule-helpers.js":"apnIf"}],"2xmbo":[function(require,module,exports) {
/*!
 * strings: 3.12.5
 * https://gsap.com
 *
...
},{"@parcel/transformer-js/src/esmodule-helpers.js":"apnIf"}],"htWnw":[function(require,module,exports) {
/*!
...
},{"@parcel/transformer-js/src/esmodule-helpers.js":"apnIf"}],"3eezk":[function(require,module,exports) {
/*!
...
},{"./utils/paths.js":"kjzT8","@parcel/transformer-js/src/esmodule-helpers.js":"apnIf"}],"kjzT8":[function(require,module,exports) {
/*!
 * paths 3.12.5
 * https://gsap.com
 *
...
},{"@parcel/transformer-js/src/esmodule-helpers.js":"apnIf"}],"63tvY":[function(require,module,exports) {
/*!
 * SplitText: 3.12.5
 * https://gsap.com
 *
...
},{"./utils/strings.js":"2xmbo","@parcel/transformer-js/src/esmodule-helpers.js":"apnIf"}],"cb3TM":[function(require,module,exports) {
module.exports = require("1dd517a10616a4e").getBundleURL("4zBYp") + "fv_bg@2x.b4b85c65.png" + "?" + Date.now();

},{"1dd517a10616a4e":"gr1F2"}],"gr1F2":[function(require,module,exports) {
"use strict";
var bundleURL = {};
...
},{}]},["j5uBC","7FRXk"], "7FRXk", "parcelRequiree1a5")

//# sourceMappingURL=index.66621293.js.map
